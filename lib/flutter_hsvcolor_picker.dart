        ...
        child: CustomMultiChildLayout(
            ...
            children: <Widget>[
              ...
              LayoutId(
                  ...
                  child: LayoutBuilder(builder: this.buildGestureDetector))
            ]));
  }

  Widget buildGestureDetector(BuildContext context, BoxConstraints box) {
    return GestureDetector(
        child: Container(color: const Color(0)),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: Container(
            ...
            width: 240,
            height: 240,
            child: CustomPaint(painter: _WheelPainter(color: this.color))));
  }
}
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
      ...
      SizedBox(
          ...
          child: Padding(
              ...
              child: PalettePicker(
                  position: Offset(this.color.saturation, this.color.value),
    ...
    return Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
      ...
      SizedBox(
          ...
          child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 20),
              child: PalettePicker(
                  position: Offset(this.color.hue, this.color.saturation),
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
      ...
      Expanded(
        ...
        decoration: InputDecoration.collapsed(hintText: "hex code"),
      ))
    ]);
  }
}
...
class ColorPicker extends StatefulWidget {
  ...
  @override
  ColorPickerState createState() => ColorPickerState(color: this.color);
}
...
class ColorPickerState extends State<ColorPicker> {
  ...
  void initState() {
    ...
    this._pickers = [
      ...
      _IPicker(
          index: 0,
          name: "Swatches",
          builder: (context) => SwatchesPicker(
                onChanged: (value) =>
      ...
      _IPicker(
          index: 4,
          name: "Palette Hue",
          builder: (context) => PaletteHuePicker(
                color: this._hSVColor,
                onChanged: (value) =>
                    super.setState(() => this._hSVColorOnChanged(value)),
              )),
      ...
      _IPicker(
          ...
          builder: (context) => PaletteSaturationPicker(
                color: this._hSVColor,
                onChanged: (value) =>
                    super.setState(() => this._hSVColorOnChanged(value)),
              )),
      ...
      _IPicker(
          index: 6,
          name: "Palette Value",
          builder: (context) => PaletteValuePicker(
                color: this._hSVColor,
                onChanged: (value) =>
                    super.setState(() => this._hSVColorOnChanged(value)),
              )),
  ...
  Widget _buildBody() {
    return Container(child: this._pickers[this._index].builder(context));
  }
